  ...
  return (
    <div className={`w-full bg-white border border-stone-200/90 shadow-card rounded-2xl p-6 sm:p-8 ${className}`}>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-6 border-b border-stone-200/60 gap-4">
        ...
        <div className="flex items-center space-x-2 text-xs font-medium text-emerald-800 bg-emerald-50 px-3 py-1.5 rounded-full border border-emerald-200/80">
          <span className="w-2 h-2 rounded-full bg-emerald-600"></span>
          <span>Tilkoblet Altinn & Landbruksdirektoratet</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 my-6">
        <div className="p-4 bg-bonde-oat/40 rounded-xl border border-stone-200/60">
          ...
          <span className="text-xs text-stone-500 mt-1 block">Tine, Nortura, Tilskudd</span>
        </div>
        ...
        <div className="p-4 bg-bonde-oat/40 rounded-xl border border-stone-200/60">
          ...
          <span className="text-xs text-stone-500 mt-1 block">Gjødsel, Fôr, Diesel</span>
        </div>

        <div className="p-4 bg-bonde-oat/40 rounded-xl border border-stone-200/60">
          <span className="text-[11px] font-bold uppercase tracking-wider text-stone-500 block">MVA-oppgjør (10. aug)</span>
          <span className="text-2xl font-serif font-bold text-bonde-green mt-1 block">kr 42 100</span>
          <span className="text-xs text-emerald-700 font-medium mt-1 block">✓ Klar til innsending</span>
        </div>

        <div className="p-4 bg-bonde-oat/40 rounded-xl border border-stone-200/60">
          <span className="text-[11px] font-bold uppercase tracking-wider text-stone-500 block">Aktive avtaler</span>
          <span className="text-2xl font-serif font-bold text-stone-900 mt-1 block">3 kontrakter</span>
          <span className="text-xs text-stone-500 mt-1 block">2 Forpaktning, 1 Maskin</span>
        </div>
      </div>

      {/* Simulated Recent Activity Table */}
      <div className="mt-6">
        <h4 className="text-xs font-bold uppercase tracking-wider text-stone-500 mb-3">Siste hendelser og oppgjør</h4>
          ...
          <table className="w-full text-left text-xs text-stone-700">
            ...
            <tbody className="divide-y divide-stone-100">
              ...
              <tr>
                ...
                <td className="p-3 font-medium text-stone-900">Forpaktningsavtale — Jorde Nord (Signert)</td>
                <td className="p-3"><span className="bg-amber-100/80 text-amber-900 px-2 py-0.5 rounded text-[11px]">Avtale</span></td>
                <td className="p-3 text-right font-mono font-semibold text-stone-600">BankID eSignert</td>
              </tr>
            </tbody>
          </table>
        </div>
